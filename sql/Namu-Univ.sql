...
VALUES (STAFF_SEQ.NEXTVAL, '20240416', '홍길동', TO_DATE('2024-04-16', 'YYYY-MM-DD'), 'M'
...
VALUES (STUDENT_SEQ.NEXTVAL, 4112, TO_CHAR(TO_DATE('2024-04-16', 'YYYY-MM-DD')),'이순신', TO_DATE('2024-04-16', 'YYYY-MM-DD')
...
VALUES (PROFESSOR_SEQ.NEXTVAL, TO_CHAR(TO_DATE('2024-04-15', 'YYYY-MM-DD')), '김유신', TO_DATE('2024-04-16', 'YYYY-MM-DD'), 'M'
